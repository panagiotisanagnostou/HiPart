...
The package employs an object-oriented approach for the implementation of the algorithms, similarly to that of [@Philipp2022DoubleML], while incorporating design similarities with the scikit-learn library [@pedregosa2011scikit]. Meaning, a class instance executes each of the algorithms, and the class instance's attributes are the algorithm's hyper-parameters and results.
...
The second visualization method is a dendrogram that represents the splits of all the divisive algorithms. The dendrogram's figure creation is implemented by the *SciPy* package [@2020SciPyNMeth], and it is fully parameterized as stated in the library.
...
-   the TGCA Pan-cancer [@cancerdata] (Cancer),
