...
def split_visualization(hipart_object, color_map="tab20"):
    ...
    divisive hierarchical clustering algorithm members of HIDIV package.
    ...
    ------
    TypeError
        If the hipart_object is not a member of the HIDIV package raise an
    ...
    for i in range(number_of_splits):
        ...
        if with_hist:
            ...
            make_sctter_n_marginal_scatter(
                scatter=scatter,
...
def make_sctter_n_marginal_scatter(scatter, marginal_scatter, PP, splitPoint, pr_col):
    """
    Create an Axes plot visualizing the split and data of a cloud of data.
...
def visualization_preparation(hipart_object, color_map):
    ...
    ----------
    hipart_object : dePDDP or iPDDP or kM_PDDP or PDDP object
        The object member of HIDIV package that we want to manipulate on the
        premiss of this function.
    color_map : string
        The name of the matplotlib color map to be used for the data
        visualization.
    ...
    dictionary_of_nodes : list
        ...
        were performed by the HIDIV member algorithms.
    internal_nodes : list
        The list of internal nodes of the binary tree that were created by the
        splitting of the data performed by the HIDIV algorithms.
    color_list : list
...
def create_linkage(tree_in):
    ...
    creatred by the member algorithms of the HIDIV package.
...
def linkage_data_maestro(node, dendrogram_counts, distance):
    ...
    extracted from a divisive algorithm of the HIDIV package. This process
